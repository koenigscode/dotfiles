...
lsp.on_attach(function(client, bufnr)
    ...
    vim.keymap.set("n", "nd", function() vim.diagnostic.goto_next() end, opts("Go to next diagnostic"))
    -- vim.keymap.set("n", "]d", function() vim.diagnostic.goto_prev() end, opts)
    vim.keymap.set("n", "pd", function() vim.diagnostic.goto_prev() end, opts("Go to previous diagnostic"))
